...
void SimpleShapeApplication::init() {
	...
	camera_->look_at(glm::vec3(0.0f, 0.0f, 1.25f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	pyramid->add_submesh(6, 9, new xe::ColorMaterial(glm::vec4(0.0f, 0.0f, 1.0f, 1.0f)));
	pyramid->add_submesh(9, 12, new xe::ColorMaterial(glm::vec4(0.0f, 1.0f, 0.0f, 1.0f)));
	pyramid->add_submesh(12, 15, new xe::ColorMaterial(glm::vec4(0.0f, 1.0f, 1.0f, 1.0f)));
